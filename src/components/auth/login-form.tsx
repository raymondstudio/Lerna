  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Button
          variant="outline"
          className="w-full justify-center bg-[#1c1f26] border-white/5 text-slate-200 hover:bg-[#252a33] hover:text-white hover:border-white/10 transition-colors h-11"
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="space-y-2">
          <div className="relative">
            <Input
              ...
              className="bg-[#1c1f26] border-white/5 h-11 pr-11 focus-visible:ring-cyan-500/50"
            />
            <button
              type="button"
        ...
        {!ready ? <p className="text-sm text-slate-400">Initializing...</p> : null}
        <Button className="w-full h-11 bg-cyan-500 text-slate-950 hover:bg-cyan-400" type="submit" disabled={loading || !ready}>
