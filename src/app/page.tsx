...
function DemoChat() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto rounded-[2.5rem] border border-white/10 bg-[#0a0a0a]/80 backdrop-blur-3xl p-2 shadow-2xl relative overflow-hidden group">
      {/* Glossy top edge highlight */}
      <div className="absolute top-0 left-1/4 right-1/4 h-[1px] bg-gradient-to-r from-transparent via-white/20 to-transparent" />
      
      <div className="bg-[#111] rounded-[2rem] border border-white/5 p-6 sm:p-8 relative overflow-hidden h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-8 relative z-10">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400/20 to-teal-400/5 border border-cyan-500/20 text-cyan-400 shadow-inner">
              <Brain className="h-6 w-6" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white tracking-tight">Interactive AI Tutor</h3>
              <p className="text-sm text-slate-400">Powered by Lerna Intelligence</p>
            </div>
          </div>
        ...
        <div className="space-y-6 mb-8 flex-1 relative z-10">
          <div className="flex gap-4">
            ...
            <div className="bg-white/5 border border-white/5 rounded-2xl rounded-tl-sm p-4 text-sm text-slate-200 leading-relaxed max-w-[85%]">
              Hello! I'm your Lerna AI tutor. I can help you understand complex topics, summarize your lecture notes, or create practice quizzes. What would you like to study today?
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {starters.map((starter) => (
              <button
                ...
                type="button"
                disabled
                className="text-xs font-medium text-slate-300 bg-white/5 hover:bg-white/10 border border-white/10 rounded-full px-4 py-2 transition-all cursor-not-allowed"
              >
                {starter}
              </button>
            ))}
          ...
          {/* Input row */}
          <div className="flex gap-3 relative group/input">
            ...
            <input
              ...
              disabled
              className="relative flex-1 bg-black/60 backdrop-blur-sm border border-white/10 rounded-2xl px-6 py-4 text-base text-white placeholder-slate-500 focus:outline-none focus:border-cyan-500/50 transition-colors shadow-inner"
            />
            <button
              type="button"
              disabled
              className="relative h-auto px-6 rounded-2xl bg-white text-black font-semibold text-sm cursor-not-allowed flex items-center justify-center gap-2 hover:bg-slate-200 transition-colors"
            >
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-slate-200 selection:bg-cyan-500/30 font-body overflow-x-hidden [&_*]:[animation:none!important] [&_*]:[transition:none!important]">
      ...
      />
        {/* Floating Navigation */}
      <nav
        className="absolute md:fixed top-6 left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-5xl z-50 rounded-full border border-white/5 bg-white/[0.02] backdrop-blur-2xl shadow-[0_30px_60px_rgba(0,0,0,0.4)]"
      >
        <div className="flex items-center justify-between px-3 py-2 sm:px-4">
          ...
          <div className="hidden md:flex items-center gap-8 bg-white/[0.03] px-8 py-2.5 rounded-full border border-white/5">
          ...
          <div className="hidden md:flex items-center gap-4">
            <button onClick={() => setActiveModal("login")} className="text-sm font-medium text-slate-300 hover:text-white transition-colors px-4">
              Sign in
            </button>
          ...
          <button 
            ...
            className="flex md:hidden items-center justify-center p-2 pr-4 text-slate-400 hover:text-white transition-colors"
          >
            {isMobileMenuOpen ? (
              <X className="h-6 w-6" />
            ) : (
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <div
              className="md:hidden absolute top-[calc(100%+0.5rem)] left-0 right-0 rounded-[2rem] border border-white/5 bg-[#0a0a0a]/95 backdrop-blur-3xl p-6 shadow-2xl flex flex-col gap-6 z-40 overflow-hidden"
            >
      ...
      <section id="how-it-works" className="py-32 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 h-[400px] w-[400px] bg-cyan-500/5 rounded-full blur-[100px] pointer-events-none" />
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="mb-20">
            <h2 className="font-heading text-4xl sm:text-5xl font-semibold tracking-tight text-white mb-6">
              Three simple steps to <span className="text-cyan-400">smarter learning</span>
            </h2>
          ...
          <div className="bg-[#111] border border-white/5 rounded-[3rem] p-4 sm:p-6 lg:p-8 relative">
            {/* Subtle inner glow */}
            <div className="absolute inset-0 bg-gradient-to-br from-white/[0.02] to-transparent rounded-[3rem] pointer-events-none" />
            ...
            <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 relative z-10">
              {steps.map((step, idx) => (
                <motion.div
                  ...
                  className="bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 sm:p-10 flex flex-col justify-between hover:bg-[#0c0c0c] transition-colors relative overflow-hidden group"
                >
                  <div className="absolute -right-12 -top-12 text-[12rem] font-bold text-white/[0.02] group-hover:text-cyan-500/[0.02] transition-colors pointer-events-none leading-none select-none">
                    {step.number}
                  </div>
                  <div className="relative z-10">
                    <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-xl font-bold text-cyan-400 mb-8 shadow-inner">
                      {step.number}
                    </div>
      ...
      <section id="features" className="mx-auto max-w-7xl px-6 py-24 sm:py-32 overflow-hidden">
        <div className="mb-20">
          <h2 className="font-heading text-4xl sm:text-5xl font-semibold tracking-tight text-white mb-6">
            ...
            <span className="text-cyan-400">personal AI tutor</span>
          </h2>
          <p className="text-lg sm:text-xl text-slate-400 max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 auto-rows-[280px]">
          {features.map((feature, i) => {
            ...
            if (i === 0) {
              ...
              bgClass = "bg-gradient-to-br from-[#111] to-[#0a1a2a]";
              innerContent = (
                <div className="absolute right-0 bottom-0 w-3/4 h-2/3 bg-black/40 border-t border-l border-white/10 rounded-tl-3xl backdrop-blur-md p-6 overflow-hidden hidden sm:block">
                  <div className="flex flex-col gap-4">
                    <div className="bg-white/5 rounded-2xl p-4 w-4/5 ml-auto border border-white/5">
                      <div className="h-2 w-1/2 bg-white/10 rounded-full mb-2"></div>
                      <div className="h-2 w-3/4 bg-white/10 rounded-full"></div>
                    </div>
                    <div className="bg-cyan-500/10 rounded-2xl p-4 w-4/5 mr-auto border border-cyan-500/20">
                      <div className="h-2 w-full bg-cyan-400/20 rounded-full mb-2"></div>
                      <div className="h-2 w-2/3 bg-cyan-400/20 rounded-full"></div>
                    </div>
                  </div>
                </div>
              );
            ...
            return (
              <motion.div 
                ...
                className={`relative ${bgClass} border border-white/5 p-8 rounded-[2rem] overflow-hidden group hover:border-cyan-500/30 transition-colors ${spanClass} flex flex-col justify-between`}
              >
                <div className="absolute inset-0 bg-white/[0.01] opacity-0 group-hover:opacity-100 transition-opacity" />
                
                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/5 border border-white/10 text-white shadow-inner group-hover:bg-cyan-500/10 group-hover:text-cyan-400 group-hover:border-cyan-500/20 transition-all duration-300">
                      <Icon className="h-5 w-5" />
                    </div>
                    {feature.isComingSoon && (
                      <span className="text-[10px] uppercase tracking-wider bg-white/5 text-slate-400 font-bold px-3 py-1.5 rounded-full border border-white/10">
                        Coming Soon
                      </span>
                    )}
                  </div>
                  <h3 className={`font-semibold text-white mb-2 tracking-tight ${i === 0 ? 'text-3xl' : 'text-xl'}`}>
                    {feature.title}
                  </h3>
                  <p className={`text-slate-400 leading-relaxed ${i === 0 ? 'text-lg max-w-sm' : 'text-sm'}`}>
                    {feature.description}
                  </p>
                </div>
      ...
      <section id="pricing" className="py-24 sm:py-32 relative overflow-hidden">
        <div className="absolute bottom-0 right-1/4 h-[500px] w-[500px] bg-cyan-500/5 rounded-full blur-[120px] pointer-events-none" />
        <div className="mx-auto max-w-7xl px-6 relative z-10">
            ...
            {pricingPlans.map((plan, index) => (
              <motion.div
                ...
                className={`flex flex-col justify-between p-8 sm:p-10 relative overflow-hidden transition-all group ${
                  plan.isComingSoon 
                    ? "bg-[#0a0a0a] border border-white/5 rounded-[2.5rem]" 
                    : "bg-gradient-to-b from-[#111] to-[#0c141c] border border-cyan-500/20 rounded-[2.5rem] shadow-[0_0_80px_rgba(6,182,212,0.05)] scale-100 md:scale-105 z-10"
                }`}
              >
                ...
                {plan.isComingSoon && (
                  <div className="absolute top-6 right-6 bg-white/5 border border-white/10 text-slate-400 text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-full">
                    Coming Soon
                  </div>
                )}
                <div className="relative z-10">
                  ...
                  <ul className="space-y-4 mb-8">
                    {plan.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3 text-slate-300 text-sm sm:text-base">
                        <CheckCircle2 className={`h-5 w-5 shrink-0 mt-0.5 ${plan.isComingSoon ? "text-slate-500" : "text-cyan-400"}`} />
                        <span>{feature}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  <Button
                    ...
                    className={`w-full h-14 rounded-2xl text-base font-semibold transition-all ${
                      plan.isComingSoon
                        ...
                        : "bg-cyan-500 text-slate-950 hover:bg-cyan-400 shadow-[0_0_20px_rgba(6,182,212,0.25)] hover:shadow-[0_0_30px_rgba(6,182,212,0.4)]"
                    }`}
                  >
                    {plan.buttonText}
                  </Button>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {testimonials.map((t, idx) => (
            <motion.div
              ...
              className="bg-[#111] border border-white/5 rounded-[2rem] p-8 sm:p-10 flex flex-col justify-between relative overflow-hidden group hover:border-cyan-500/20 transition-all"
            >
              <div className="absolute inset-0 bg-white/[0.01] opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="relative z-10">
      ...
      <section id="community" className="mx-auto max-w-6xl px-6 py-24 sm:py-32 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-cyan-500/20 bg-cyan-500/5 px-4 py-1.5 text-xs sm:text-sm font-medium text-cyan-300 mb-6 hover:bg-cyan-500/10 transition-colors backdrop-blur-sm"
          >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-[2.5rem] border border-emerald-500/20 bg-emerald-950/20 p-10 flex flex-col justify-between group hover:border-emerald-500/40 transition-all"
          >
            ...
            <div className="relative z-10">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-8 shadow-inner group-hover:scale-110 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3">WhatsApp Study Group</h3>
              <p className="text-base text-emerald-100/60 leading-relaxed mb-10 max-w-sm">
            ...
            <Link
              ...
              className="relative z-10 inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-emerald-950 font-bold px-6 h-12 text-sm transition-all shadow-[0_0_30px_rgba(16,185,129,0.2)] w-fit"
            >
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-[2.5rem] border border-indigo-500/20 bg-indigo-950/20 p-10 flex flex-col justify-between group hover:border-indigo-500/40 transition-all"
          >
            ...
            <div className="relative z-10">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 mb-8 shadow-inner group-hover:scale-110 transition-transform duration-300">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3">Discord Server</h3>
              <p className="text-base text-indigo-100/60 leading-relaxed mb-10 max-w-sm">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative z-10 inline-flex items-center justify-center gap-2 rounded-2xl bg-indigo-500 hover:bg-indigo-400 text-white font-bold px-6 h-12 text-sm transition-all shadow-[0_0_30px_rgba(99,102,241,0.2)] w-fit"
            >
      ...
      <section id="faq" className="py-24 sm:py-32 relative overflow-hidden">
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          <div className="bg-[#111] border border-white/5 rounded-[2.5rem] p-8 sm:p-12 max-w-3xl mx-auto shadow-2xl relative">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20 text-center relative z-10">
        <motion.div 
          ...
          viewport={{ once: true, margin: "-50px" }}
          transition={{ duration: 0.6 }}
          className="relative overflow-hidden rounded-[3rem] border border-emerald-500/20 bg-[#111] p-10 sm:p-16 shadow-2xl"
        >
          ...
          <div className="flex flex-col items-center justify-center text-center gap-8 relative z-10">
            ...
            <div className="max-w-xl">
              <h3 className="text-3xl sm:text-4xl font-semibold text-white mb-4 tracking-tight">Prefer WhatsApp?</h3>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-500 hover:bg-emerald-400 text-emerald-950 font-bold px-10 h-14 text-base transition-all shadow-[0_0_30px_rgba(16,185,129,0.2)] hover:scale-[1.02] active:scale-[0.98]"
            >
              Start WhatsApp Chat
            </Link>
          </div>
      ...
      <footer className="bg-[#0a0a0a] pt-32 pb-12 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10 mb-32 text-center">
          ...
          >
            <h2 className="text-5xl sm:text-7xl font-bold text-white tracking-tight mb-8">Ready to <span className="text-cyan-400">excel?</span></h2>
            <div className="flex gap-4 justify-center items-center">
              <Button 
                onClick={() => setActiveModal("signup")} 
                className="bg-white text-black hover:bg-slate-200 rounded-full px-10 h-16 text-lg font-semibold transition-all shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:scale-[1.02]"
              >
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="bg-[#111] border border-white/5 rounded-[3rem] p-12 sm:p-16">
